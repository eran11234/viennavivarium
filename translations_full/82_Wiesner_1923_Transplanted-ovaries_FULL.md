...
> ¹) [Footnote marker ¹) appears in the source text after "'hydraulic' action." The corresponding footnote text is not printed at the foot of page 8 in this section; it presumably falls on a subsequent (adjacent) page. Marker preserved here.] Firstly, the transplants show a more or less far-reaching reduction of the follicle count, which can already be explained by the not entirely adequate nourishment of the transplant.
...
![](figures/82_Wiesner_1923_Transplanted-ovaries/Plate_V.jpg)
