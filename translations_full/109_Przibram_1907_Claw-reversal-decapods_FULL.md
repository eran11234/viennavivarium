...
This concludes the great regeneration census table (printed pp. 328–335). On the following printed page (336) the running text resumes with a new section, **"J. Erklärung der Abbildungen"** (Explanation of the figures), which lies beyond these pages.
...
![](figures/109_Przibram_1907_Claw-reversal-decapods/Taf_XI.jpg)
